...
const Header: React.FC = () => {
  ...
  return (
    <header className="top-0 z-50 flex items-center justify-between w-full px-4 py-4 bg-white border-b-4 shadow-sm rounded-b-2xl md:px-24 border-friends-purple">
