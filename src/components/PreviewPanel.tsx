...
const PreviewPanel: React.FC<PreviewPanelProps> = ({
  ...
  return (
    <div
      className="w-full lg:w-7/12 md:min-h-[500px] "
      data-tour="preview-panel">
      <div
        className={`
          relative w-full md:min-h-[510px] bg-white border-4 border-friends-purple rounded-2xl flex flex-col items-center justify-center overflow-hidden shadow-xl
          ${
        ...
        {isGeneratingVideo ? (
          ...
          <div className="relative w-full h-full group bg-gray-50">
            ...
            <div className="absolute transition-opacity duration-300 opacity-0 top-10 right-10 md:top-12 md:right-12 group-hover:opacity-100">
              <button
