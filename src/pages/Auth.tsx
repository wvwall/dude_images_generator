...
const Auth: React.FC = () => {
  ...
  return (
    <div className="h-screen p-4 pt-8">
      <div className="w-full max-w-md mx-auto mt-6 overflow-hidden border shadow-2xl rounded-2xl backdrop-blur-lg bg-white/80 dark:bg-dark-surface/90 border-white/20 dark:border-dark-border">
        <div className="p-8">
          <div className="mb-8 text-center">
            <h1 className="mb-2 text-4xl text-black dark:text-white font-hand">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full py-3 pl-10 pr-4 transition-all bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border text-gray-800 dark:text-gray-100 outline-hidden rounded-xl focus:ring-2 focus:ring-friends-purple dark:focus:ring-friends-yellow focus:border-transparent"
                required
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full py-3 pl-10 pr-12 transition-all bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border text-gray-800 dark:text-gray-100 outline-hidden rounded-xl focus:ring-2 focus:ring-friends-purple dark:focus:ring-friends-yellow focus:border-transparent"
                required
              />
              <button
                type="button"
